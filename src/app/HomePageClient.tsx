        ...
        <div className="flex items-center justify-between px-4 py-3 md:px-6">
          ...
          <nav className="flex items-center gap-3">
            ...
            {!mounted ? (
              ...
              <>
                {user.role === 'driver' ? (
                  <Link href="/driver" className="rounded-lg border border-primary/50 bg-primary/10 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/20">
                    Driver view
                  </Link>
                ) : user.role === 'admin' ? (
                  <Link href="/admin" className="rounded-lg border border-primary/50 bg-primary/10 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/20">
                    Admin
                  </Link>
                ) : (
                  <Link href="/dashboard" className="rounded-lg border border-primary/50 bg-primary/10 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/20">
                    Dashboard
                  </Link>
                )}
